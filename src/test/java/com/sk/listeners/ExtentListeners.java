...
import com.sk.utilities.ExtentManager;
import com.sk.utilities.MonitoringMail;
import com.sk.utilities.TestConfig;
...
//	}
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			testReport.get().info(TestUtil.screenshotPath);
			testReport.get().fail("<b>" + "<font color=" + "red>" + "Screenshot of failure" + "</font>" + "</b>",
					MediaEntityBuilder.createScreenCaptureFromPath(TestUtil.screenshotPath).build());
			
		} catch (IOException e) {
		
		testReport.get().fail("Test Failed, Cannot attach screeshot");
